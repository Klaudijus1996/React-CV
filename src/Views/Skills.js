            ...
            <div className="container mx-auto flex flex-wrap justify-between">
                {
                    boxTransition.map(({ item, key, props }) =>
                        ...
                        <animated.div
                            key={key}
                            style={props}
                            className={showElements ? "w-1/4 transition duration-500 shadow-xl p-2 text-center m-2 my-4 hover:bg-orange-100 bg-white border-l border-b border-r" : "hidden"}>
