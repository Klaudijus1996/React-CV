    ...
    return (
        <section className="bg-blue-100 p-5">
            ...
            <div className="container flex flex-wrap justify-between">
                <div className="w-1/4 shadow-xl p-2 text-center m-2 my-4 border-l border-b border-r">
                    <h4 className="text-orange-500 text-5xl hover:text-orange-600 h-16 w-16 mr-auto ml-auto"><FontAwesomeIcon icon={faHtml5} /></h4>
                    <p style={{ fontFamily: "'EB Garamond', serif" }} className="text-lg">
                ...
                <div className="w-1/4 shadow-xl p-2 text-center m-2 my-4 border-l border-b border-r">
                    <div className="text-yellow-400 text-5xl hover:text-yellow-500 w-16 h-16 mr-auto ml-auto"><FontAwesomeIcon icon={faJs} /></div>
                    <p style={{ fontFamily: "'EB Garamond', serif" }} className="text-lg">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam, vero asperiores incidunt vitae quod perferendis?
                    </p>
                </div>
