    ...
    return (
        <section id="contact" className="bg-blue-100 p-5 pb-32">
            ...
            <div className="container mx-auto flex justify-between p-10">
                <div className={showElements ? "w-2/5 bg-white" : "hidden"}>
                    <ul className="w-4/5 mr-auto ml-auto">
                        <li className={showElements ? "anim-delay-500 py-4 flex items-center" : "hidden"}>
                ...
                <div className={showElements ? "w-2/5 bg-gray-300 shadow-lg" : "hidden"}>
